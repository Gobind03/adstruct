...
@Entity
@Table(
        name = "brand_rule_sets",
        uniqueConstraints = @UniqueConstraint(columnNames = {"org_id", "workspace_id", "name"}))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class BrandRuleSet {
    ...
    @Builder.Default
    private ComplianceDomain domain = ComplianceDomain.GENERAL;
